...
moveit_msgs__srv__SaveRobotStateToWarehouse_Request__init(moveit_msgs__srv__SaveRobotStateToWarehouse_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->name)) {
    moveit_msgs__srv__SaveRobotStateToWarehouse_Request__fini(msg);
    return false;
  }
  // robot
...
{
  moveit_msgs__srv__SaveRobotStateToWarehouse_Request * msg = (moveit_msgs__srv__SaveRobotStateToWarehouse_Request *)malloc(sizeof(moveit_msgs__srv__SaveRobotStateToWarehouse_Request));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(moveit_msgs__srv__SaveRobotStateToWarehouse_Request));
  bool success = moveit_msgs__srv__SaveRobotStateToWarehouse_Request__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
moveit_msgs__srv__SaveRobotStateToWarehouse_Request__Sequence__init(moveit_msgs__srv__SaveRobotStateToWarehouse_Request__Sequence * array, size_t size)
{
  ...
  moveit_msgs__srv__SaveRobotStateToWarehouse_Request * data = NULL;
  if (size) {
    data = (moveit_msgs__srv__SaveRobotStateToWarehouse_Request *)calloc(size, sizeof(moveit_msgs__srv__SaveRobotStateToWarehouse_Request));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = moveit_msgs__srv__SaveRobotStateToWarehouse_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        moveit_msgs__srv__SaveRobotStateToWarehouse_Request__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
moveit_msgs__srv__SaveRobotStateToWarehouse_Request__Sequence__fini(moveit_msgs__srv__SaveRobotStateToWarehouse_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      moveit_msgs__srv__SaveRobotStateToWarehouse_Request__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  moveit_msgs__srv__SaveRobotStateToWarehouse_Request__Sequence * array = (moveit_msgs__srv__SaveRobotStateToWarehouse_Request__Sequence *)malloc(sizeof(moveit_msgs__srv__SaveRobotStateToWarehouse_Request__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = moveit_msgs__srv__SaveRobotStateToWarehouse_Request__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    moveit_msgs__srv__SaveRobotStateToWarehouse_Request__Sequence__fini(array);
  }
  free(array);
}
...
moveit_msgs__srv__SaveRobotStateToWarehouse_Request__Sequence__are_equal(const moveit_msgs__srv__SaveRobotStateToWarehouse_Request__Sequence * lhs, const moveit_msgs__srv__SaveRobotStateToWarehouse_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!moveit_msgs__srv__SaveRobotStateToWarehouse_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  moveit_msgs__srv__SaveRobotStateToWarehouse_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(moveit_msgs__srv__SaveRobotStateToWarehouse_Request);
    moveit_msgs__srv__SaveRobotStateToWarehouse_Request * data =
      (moveit_msgs__srv__SaveRobotStateToWarehouse_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__srv__SaveRobotStateToWarehouse_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__srv__SaveRobotStateToWarehouse_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!moveit_msgs__srv__SaveRobotStateToWarehouse_Request__copy(
...
{
  moveit_msgs__srv__SaveRobotStateToWarehouse_Response * msg = (moveit_msgs__srv__SaveRobotStateToWarehouse_Response *)malloc(sizeof(moveit_msgs__srv__SaveRobotStateToWarehouse_Response));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(moveit_msgs__srv__SaveRobotStateToWarehouse_Response));
  bool success = moveit_msgs__srv__SaveRobotStateToWarehouse_Response__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
{
  if (msg) {
    moveit_msgs__srv__SaveRobotStateToWarehouse_Response__fini(msg);
  }
  free(msg);
}
...
moveit_msgs__srv__SaveRobotStateToWarehouse_Response__Sequence__init(moveit_msgs__srv__SaveRobotStateToWarehouse_Response__Sequence * array, size_t size)
{
  ...
  moveit_msgs__srv__SaveRobotStateToWarehouse_Response * data = NULL;
  if (size) {
    data = (moveit_msgs__srv__SaveRobotStateToWarehouse_Response *)calloc(size, sizeof(moveit_msgs__srv__SaveRobotStateToWarehouse_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = moveit_msgs__srv__SaveRobotStateToWarehouse_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        moveit_msgs__srv__SaveRobotStateToWarehouse_Response__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
moveit_msgs__srv__SaveRobotStateToWarehouse_Response__Sequence__fini(moveit_msgs__srv__SaveRobotStateToWarehouse_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      moveit_msgs__srv__SaveRobotStateToWarehouse_Response__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  moveit_msgs__srv__SaveRobotStateToWarehouse_Response__Sequence * array = (moveit_msgs__srv__SaveRobotStateToWarehouse_Response__Sequence *)malloc(sizeof(moveit_msgs__srv__SaveRobotStateToWarehouse_Response__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = moveit_msgs__srv__SaveRobotStateToWarehouse_Response__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    moveit_msgs__srv__SaveRobotStateToWarehouse_Response__Sequence__fini(array);
  }
  free(array);
}
...
moveit_msgs__srv__SaveRobotStateToWarehouse_Response__Sequence__are_equal(const moveit_msgs__srv__SaveRobotStateToWarehouse_Response__Sequence * lhs, const moveit_msgs__srv__SaveRobotStateToWarehouse_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!moveit_msgs__srv__SaveRobotStateToWarehouse_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  moveit_msgs__srv__SaveRobotStateToWarehouse_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(moveit_msgs__srv__SaveRobotStateToWarehouse_Response);
    moveit_msgs__srv__SaveRobotStateToWarehouse_Response * data =
      (moveit_msgs__srv__SaveRobotStateToWarehouse_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__srv__SaveRobotStateToWarehouse_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__srv__SaveRobotStateToWarehouse_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!moveit_msgs__srv__SaveRobotStateToWarehouse_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
