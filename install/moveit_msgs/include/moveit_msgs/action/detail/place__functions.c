  ...
  moveit_msgs__action__Place_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    moveit_msgs__action__Place_Goal * data =
      (moveit_msgs__action__Place_Goal *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__Place_Goal__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__Place_Goal__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  moveit_msgs__action__Place_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    moveit_msgs__action__Place_Result * data =
      (moveit_msgs__action__Place_Result *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__Place_Result__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__Place_Result__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  moveit_msgs__action__Place_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    moveit_msgs__action__Place_Feedback * data =
      (moveit_msgs__action__Place_Feedback *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__Place_Feedback__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__Place_Feedback__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  moveit_msgs__action__Place_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    moveit_msgs__action__Place_SendGoal_Request * data =
      (moveit_msgs__action__Place_SendGoal_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__Place_SendGoal_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__Place_SendGoal_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  moveit_msgs__action__Place_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    moveit_msgs__action__Place_SendGoal_Response * data =
      (moveit_msgs__action__Place_SendGoal_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__Place_SendGoal_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__Place_SendGoal_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  moveit_msgs__action__Place_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    moveit_msgs__action__Place_GetResult_Request * data =
      (moveit_msgs__action__Place_GetResult_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__Place_GetResult_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__Place_GetResult_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  moveit_msgs__action__Place_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    moveit_msgs__action__Place_GetResult_Response * data =
      (moveit_msgs__action__Place_GetResult_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__Place_GetResult_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__Place_GetResult_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  moveit_msgs__action__Place_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    moveit_msgs__action__Place_FeedbackMessage * data =
      (moveit_msgs__action__Place_FeedbackMessage *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__Place_FeedbackMessage__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__Place_FeedbackMessage__fini(&data[i]);
        }
        free(data);
        return false;
      }
