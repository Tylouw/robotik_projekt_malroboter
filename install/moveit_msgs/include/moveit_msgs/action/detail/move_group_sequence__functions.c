...
bool
moveit_msgs__action__MoveGroupSequence_Goal__are_equal(const moveit_msgs__action__MoveGroupSequence_Goal * lhs, const moveit_msgs__action__MoveGroupSequence_Goal * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
moveit_msgs__action__MoveGroupSequence_Goal__copy(
  const moveit_msgs__action__MoveGroupSequence_Goal * input,
  moveit_msgs__action__MoveGroupSequence_Goal * output)
{
  if (!input || !output) {
    return false;
  }
...
bool
moveit_msgs__action__MoveGroupSequence_Goal__Sequence__are_equal(const moveit_msgs__action__MoveGroupSequence_Goal__Sequence * lhs, const moveit_msgs__action__MoveGroupSequence_Goal__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!moveit_msgs__action__MoveGroupSequence_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
moveit_msgs__action__MoveGroupSequence_Goal__Sequence__copy(
  const moveit_msgs__action__MoveGroupSequence_Goal__Sequence * input,
  moveit_msgs__action__MoveGroupSequence_Goal__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(moveit_msgs__action__MoveGroupSequence_Goal);
    moveit_msgs__action__MoveGroupSequence_Goal * data =
      (moveit_msgs__action__MoveGroupSequence_Goal *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__MoveGroupSequence_Goal__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__MoveGroupSequence_Goal__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!moveit_msgs__action__MoveGroupSequence_Goal__copy(
...
bool
moveit_msgs__action__MoveGroupSequence_Result__are_equal(const moveit_msgs__action__MoveGroupSequence_Result * lhs, const moveit_msgs__action__MoveGroupSequence_Result * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
moveit_msgs__action__MoveGroupSequence_Result__copy(
  const moveit_msgs__action__MoveGroupSequence_Result * input,
  moveit_msgs__action__MoveGroupSequence_Result * output)
{
  if (!input || !output) {
    return false;
  }
...
bool
moveit_msgs__action__MoveGroupSequence_Result__Sequence__are_equal(const moveit_msgs__action__MoveGroupSequence_Result__Sequence * lhs, const moveit_msgs__action__MoveGroupSequence_Result__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!moveit_msgs__action__MoveGroupSequence_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
moveit_msgs__action__MoveGroupSequence_Result__Sequence__copy(
  const moveit_msgs__action__MoveGroupSequence_Result__Sequence * input,
  moveit_msgs__action__MoveGroupSequence_Result__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(moveit_msgs__action__MoveGroupSequence_Result);
    moveit_msgs__action__MoveGroupSequence_Result * data =
      (moveit_msgs__action__MoveGroupSequence_Result *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__MoveGroupSequence_Result__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__MoveGroupSequence_Result__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!moveit_msgs__action__MoveGroupSequence_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
bool
moveit_msgs__action__MoveGroupSequence_Feedback__are_equal(const moveit_msgs__action__MoveGroupSequence_Feedback * lhs, const moveit_msgs__action__MoveGroupSequence_Feedback * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
moveit_msgs__action__MoveGroupSequence_Feedback__copy(
  const moveit_msgs__action__MoveGroupSequence_Feedback * input,
  moveit_msgs__action__MoveGroupSequence_Feedback * output)
{
  if (!input || !output) {
    return false;
  }
...
bool
moveit_msgs__action__MoveGroupSequence_Feedback__Sequence__are_equal(const moveit_msgs__action__MoveGroupSequence_Feedback__Sequence * lhs, const moveit_msgs__action__MoveGroupSequence_Feedback__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!moveit_msgs__action__MoveGroupSequence_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
moveit_msgs__action__MoveGroupSequence_Feedback__Sequence__copy(
  const moveit_msgs__action__MoveGroupSequence_Feedback__Sequence * input,
  moveit_msgs__action__MoveGroupSequence_Feedback__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(moveit_msgs__action__MoveGroupSequence_Feedback);
    moveit_msgs__action__MoveGroupSequence_Feedback * data =
      (moveit_msgs__action__MoveGroupSequence_Feedback *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__MoveGroupSequence_Feedback__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__MoveGroupSequence_Feedback__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!moveit_msgs__action__MoveGroupSequence_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
bool
moveit_msgs__action__MoveGroupSequence_SendGoal_Request__are_equal(const moveit_msgs__action__MoveGroupSequence_SendGoal_Request * lhs, const moveit_msgs__action__MoveGroupSequence_SendGoal_Request * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // goal
  if (!moveit_msgs__action__MoveGroupSequence_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
bool
moveit_msgs__action__MoveGroupSequence_SendGoal_Request__copy(
  const moveit_msgs__action__MoveGroupSequence_SendGoal_Request * input,
  moveit_msgs__action__MoveGroupSequence_SendGoal_Request * output)
{
  if (!input || !output) {
    return false;
  }
...
bool
moveit_msgs__action__MoveGroupSequence_SendGoal_Request__Sequence__are_equal(const moveit_msgs__action__MoveGroupSequence_SendGoal_Request__Sequence * lhs, const moveit_msgs__action__MoveGroupSequence_SendGoal_Request__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!moveit_msgs__action__MoveGroupSequence_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
moveit_msgs__action__MoveGroupSequence_SendGoal_Request__Sequence__copy(
  const moveit_msgs__action__MoveGroupSequence_SendGoal_Request__Sequence * input,
  moveit_msgs__action__MoveGroupSequence_SendGoal_Request__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(moveit_msgs__action__MoveGroupSequence_SendGoal_Request);
    moveit_msgs__action__MoveGroupSequence_SendGoal_Request * data =
      (moveit_msgs__action__MoveGroupSequence_SendGoal_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__MoveGroupSequence_SendGoal_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__MoveGroupSequence_SendGoal_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!moveit_msgs__action__MoveGroupSequence_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
bool
moveit_msgs__action__MoveGroupSequence_SendGoal_Response__are_equal(const moveit_msgs__action__MoveGroupSequence_SendGoal_Response * lhs, const moveit_msgs__action__MoveGroupSequence_SendGoal_Response * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
moveit_msgs__action__MoveGroupSequence_SendGoal_Response__copy(
  const moveit_msgs__action__MoveGroupSequence_SendGoal_Response * input,
  moveit_msgs__action__MoveGroupSequence_SendGoal_Response * output)
{
  if (!input || !output) {
    return false;
  }
...
bool
moveit_msgs__action__MoveGroupSequence_SendGoal_Response__Sequence__are_equal(const moveit_msgs__action__MoveGroupSequence_SendGoal_Response__Sequence * lhs, const moveit_msgs__action__MoveGroupSequence_SendGoal_Response__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!moveit_msgs__action__MoveGroupSequence_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
moveit_msgs__action__MoveGroupSequence_SendGoal_Response__Sequence__copy(
  const moveit_msgs__action__MoveGroupSequence_SendGoal_Response__Sequence * input,
  moveit_msgs__action__MoveGroupSequence_SendGoal_Response__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(moveit_msgs__action__MoveGroupSequence_SendGoal_Response);
    moveit_msgs__action__MoveGroupSequence_SendGoal_Response * data =
      (moveit_msgs__action__MoveGroupSequence_SendGoal_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__MoveGroupSequence_SendGoal_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__MoveGroupSequence_SendGoal_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!moveit_msgs__action__MoveGroupSequence_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
bool
moveit_msgs__action__MoveGroupSequence_GetResult_Request__are_equal(const moveit_msgs__action__MoveGroupSequence_GetResult_Request * lhs, const moveit_msgs__action__MoveGroupSequence_GetResult_Request * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
moveit_msgs__action__MoveGroupSequence_GetResult_Request__copy(
  const moveit_msgs__action__MoveGroupSequence_GetResult_Request * input,
  moveit_msgs__action__MoveGroupSequence_GetResult_Request * output)
{
  if (!input || !output) {
    return false;
  }
...
bool
moveit_msgs__action__MoveGroupSequence_GetResult_Request__Sequence__are_equal(const moveit_msgs__action__MoveGroupSequence_GetResult_Request__Sequence * lhs, const moveit_msgs__action__MoveGroupSequence_GetResult_Request__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!moveit_msgs__action__MoveGroupSequence_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
moveit_msgs__action__MoveGroupSequence_GetResult_Request__Sequence__copy(
  const moveit_msgs__action__MoveGroupSequence_GetResult_Request__Sequence * input,
  moveit_msgs__action__MoveGroupSequence_GetResult_Request__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(moveit_msgs__action__MoveGroupSequence_GetResult_Request);
    moveit_msgs__action__MoveGroupSequence_GetResult_Request * data =
      (moveit_msgs__action__MoveGroupSequence_GetResult_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__MoveGroupSequence_GetResult_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__MoveGroupSequence_GetResult_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!moveit_msgs__action__MoveGroupSequence_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
bool
moveit_msgs__action__MoveGroupSequence_GetResult_Response__are_equal(const moveit_msgs__action__MoveGroupSequence_GetResult_Response * lhs, const moveit_msgs__action__MoveGroupSequence_GetResult_Response * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // result
  if (!moveit_msgs__action__MoveGroupSequence_Result__are_equal(
...
bool
moveit_msgs__action__MoveGroupSequence_GetResult_Response__copy(
  const moveit_msgs__action__MoveGroupSequence_GetResult_Response * input,
  moveit_msgs__action__MoveGroupSequence_GetResult_Response * output)
{
  if (!input || !output) {
    return false;
  }
...
bool
moveit_msgs__action__MoveGroupSequence_GetResult_Response__Sequence__are_equal(const moveit_msgs__action__MoveGroupSequence_GetResult_Response__Sequence * lhs, const moveit_msgs__action__MoveGroupSequence_GetResult_Response__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!moveit_msgs__action__MoveGroupSequence_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
moveit_msgs__action__MoveGroupSequence_GetResult_Response__Sequence__copy(
  const moveit_msgs__action__MoveGroupSequence_GetResult_Response__Sequence * input,
  moveit_msgs__action__MoveGroupSequence_GetResult_Response__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(moveit_msgs__action__MoveGroupSequence_GetResult_Response);
    moveit_msgs__action__MoveGroupSequence_GetResult_Response * data =
      (moveit_msgs__action__MoveGroupSequence_GetResult_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__MoveGroupSequence_GetResult_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__MoveGroupSequence_GetResult_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!moveit_msgs__action__MoveGroupSequence_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
bool
moveit_msgs__action__MoveGroupSequence_FeedbackMessage__are_equal(const moveit_msgs__action__MoveGroupSequence_FeedbackMessage * lhs, const moveit_msgs__action__MoveGroupSequence_FeedbackMessage * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // feedback
  if (!moveit_msgs__action__MoveGroupSequence_Feedback__are_equal(
...
bool
moveit_msgs__action__MoveGroupSequence_FeedbackMessage__copy(
  const moveit_msgs__action__MoveGroupSequence_FeedbackMessage * input,
  moveit_msgs__action__MoveGroupSequence_FeedbackMessage * output)
{
  if (!input || !output) {
    return false;
  }
...
bool
moveit_msgs__action__MoveGroupSequence_FeedbackMessage__Sequence__are_equal(const moveit_msgs__action__MoveGroupSequence_FeedbackMessage__Sequence * lhs, const moveit_msgs__action__MoveGroupSequence_FeedbackMessage__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!moveit_msgs__action__MoveGroupSequence_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
moveit_msgs__action__MoveGroupSequence_FeedbackMessage__Sequence__copy(
  const moveit_msgs__action__MoveGroupSequence_FeedbackMessage__Sequence * input,
  moveit_msgs__action__MoveGroupSequence_FeedbackMessage__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(moveit_msgs__action__MoveGroupSequence_FeedbackMessage);
    moveit_msgs__action__MoveGroupSequence_FeedbackMessage * data =
      (moveit_msgs__action__MoveGroupSequence_FeedbackMessage *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__MoveGroupSequence_FeedbackMessage__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__MoveGroupSequence_FeedbackMessage__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!moveit_msgs__action__MoveGroupSequence_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
