...
bool interfaces__msg__point_orientation3_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._point_orientation3_d.PointOrientation3D", full_classname_dest, 55) == 0);
  }
  interfaces__msg__PointOrientation3D * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of PointOrientation3D */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._point_orientation3_d");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PointOrientation3D");
