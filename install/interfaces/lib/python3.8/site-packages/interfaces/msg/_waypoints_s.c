...
bool interfaces__msg__waypoints__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._waypoints.Waypoints", full_classname_dest, 35) == 0);
  }
  interfaces__msg__Waypoints * ros_message = _ros_message;
  {  // x
...
PyObject * interfaces__msg__waypoints__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._waypoints");
