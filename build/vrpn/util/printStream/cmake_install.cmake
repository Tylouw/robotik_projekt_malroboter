# Install script for directory: /home/prakt3/praktikum_ws/src/vrpn-release/util/printStream
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xclientsx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/home/prakt3/praktikum_ws/build/vrpn/util/printStream/vrpn_streamPrint")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/vrpn_streamPrint" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/vrpn_streamPrint")
