  ...
  // Field name: point
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, moveit_msgs, msg, CartesianPoint
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _CartesianTrajectoryPoint__ros_msg_type * ros_message = static_cast<_CartesianTrajectoryPoint__ros_msg_type *>(untyped_ros_message);
  // Field name: point
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
{
  return max_serialized_size_moveit_msgs__msg__CartesianTrajectoryPoint(
    full_bounded, 0);
}
