...
static size_t _MotionPlanDetailedResponse__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_moveit_msgs__msg__MotionPlanDetailedResponse(
    full_bounded, 0);
}
