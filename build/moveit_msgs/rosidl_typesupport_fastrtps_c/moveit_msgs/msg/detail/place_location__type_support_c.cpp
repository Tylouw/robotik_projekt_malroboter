  ...
  void * untyped_ros_message)
{
  ...
  _PlaceLocation__ros_msg_type * ros_message = static_cast<_PlaceLocation__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    std::string tmp;
    cdr >> tmp;
...
{
  return max_serialized_size_moveit_msgs__msg__PlaceLocation(
    full_bounded, 0);
}
