  ...
  void * untyped_ros_message)
{
  ...
  _GenericTrajectory__ros_msg_type * ros_message = static_cast<_GenericTrajectory__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
{
  return max_serialized_size_moveit_msgs__msg__GenericTrajectory(
    full_bounded, 0);
}
