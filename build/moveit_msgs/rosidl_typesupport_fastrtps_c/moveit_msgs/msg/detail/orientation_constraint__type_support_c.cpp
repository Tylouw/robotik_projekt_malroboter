...
#include "moveit_msgs/msg/detail/orientation_constraint__rosidl_typesupport_fastrtps_c.h"
...
using _OrientationConstraint__ros_msg_type = moveit_msgs__msg__OrientationConstraint;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _OrientationConstraint__ros_msg_type * ros_message = static_cast<const _OrientationConstraint__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: absolute_x_axis_tolerance
  {
    cdr << ros_message->absolute_x_axis_tolerance;
  }

  // Field name: absolute_y_axis_tolerance
  {
    cdr << ros_message->absolute_y_axis_tolerance;
  }

  // Field name: absolute_z_axis_tolerance
  {
  ...
  void * untyped_ros_message)
{
  ...
  _OrientationConstraint__ros_msg_type * ros_message = static_cast<_OrientationConstraint__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _OrientationConstraint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_moveit_msgs__msg__OrientationConstraint(
...
{
  return max_serialized_size_moveit_msgs__msg__OrientationConstraint(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_OrientationConstraint = {
  "moveit_msgs::msg",
...
static rosidl_message_type_support_t _OrientationConstraint__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_OrientationConstraint,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moveit_msgs, msg, OrientationConstraint)() {
  return &_OrientationConstraint__type_support;
}
