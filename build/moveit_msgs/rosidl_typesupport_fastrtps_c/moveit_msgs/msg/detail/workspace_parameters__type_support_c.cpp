  ...
  void * untyped_ros_message)
{
  ...
  _WorkspaceParameters__ros_msg_type * ros_message = static_cast<_WorkspaceParameters__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static size_t _WorkspaceParameters__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_moveit_msgs__msg__WorkspaceParameters(
    full_bounded, 0);
}
