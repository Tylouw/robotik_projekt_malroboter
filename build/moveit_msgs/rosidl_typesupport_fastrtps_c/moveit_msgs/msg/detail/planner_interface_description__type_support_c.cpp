...
static size_t _PlannerInterfaceDescription__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_moveit_msgs__msg__PlannerInterfaceDescription(
    full_bounded, 0);
}
