  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: type
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, object_recognition_msgs, msg, ObjectType
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  void * untyped_ros_message)
{
  ...
  _CollisionObject__ros_msg_type * ros_message = static_cast<_CollisionObject__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static size_t _CollisionObject__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_moveit_msgs__msg__CollisionObject(
    full_bounded, 0);
}
