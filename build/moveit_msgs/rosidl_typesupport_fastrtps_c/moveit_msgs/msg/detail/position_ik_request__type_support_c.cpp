  ...
  void * untyped_ros_message)
{
  ...
  _PositionIKRequest__ros_msg_type * ros_message = static_cast<_PositionIKRequest__ros_msg_type *>(untyped_ros_message);
  // Field name: group_name
  {
    std::string tmp;
    cdr >> tmp;
...
static size_t _PositionIKRequest__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_moveit_msgs__msg__PositionIKRequest(
    full_bounded, 0);
}
