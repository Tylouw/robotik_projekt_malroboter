...
{
  return max_serialized_size_moveit_msgs__srv__QueryPlannerInterfaces_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_moveit_msgs__srv__QueryPlannerInterfaces_Response(
    full_bounded, 0);
}
