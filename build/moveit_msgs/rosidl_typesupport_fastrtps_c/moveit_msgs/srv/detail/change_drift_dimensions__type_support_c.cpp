...
static size_t _ChangeDriftDimensions_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_moveit_msgs__srv__ChangeDriftDimensions_Request(
    full_bounded, 0);
}
...
static size_t _ChangeDriftDimensions_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_moveit_msgs__srv__ChangeDriftDimensions_Response(
    full_bounded, 0);
}
