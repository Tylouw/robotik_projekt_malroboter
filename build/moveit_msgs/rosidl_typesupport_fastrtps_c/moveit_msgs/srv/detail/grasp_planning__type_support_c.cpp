...
static size_t _GraspPlanning_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_moveit_msgs__srv__GraspPlanning_Request(
    full_bounded, 0);
}
...
static size_t _GraspPlanning_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_moveit_msgs__srv__GraspPlanning_Response(
    full_bounded, 0);
}
