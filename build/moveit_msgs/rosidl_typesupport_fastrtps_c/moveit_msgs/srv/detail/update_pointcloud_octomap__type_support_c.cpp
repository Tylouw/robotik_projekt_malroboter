...
static size_t _UpdatePointcloudOctomap_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_moveit_msgs__srv__UpdatePointcloudOctomap_Request(
    full_bounded, 0);
}
...
static size_t _UpdatePointcloudOctomap_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_moveit_msgs__srv__UpdatePointcloudOctomap_Response(
    full_bounded, 0);
}
