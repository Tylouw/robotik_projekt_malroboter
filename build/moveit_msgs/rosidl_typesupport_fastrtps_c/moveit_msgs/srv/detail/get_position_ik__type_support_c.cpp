...
static size_t _GetPositionIK_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_moveit_msgs__srv__GetPositionIK_Request(
    full_bounded, 0);
}
...
static size_t _GetPositionIK_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_moveit_msgs__srv__GetPositionIK_Response(
    full_bounded, 0);
}
