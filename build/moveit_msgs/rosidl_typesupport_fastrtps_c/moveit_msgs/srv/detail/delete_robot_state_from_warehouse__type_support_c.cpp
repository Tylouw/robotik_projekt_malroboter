...
{
  return max_serialized_size_moveit_msgs__srv__DeleteRobotStateFromWarehouse_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_moveit_msgs__srv__DeleteRobotStateFromWarehouse_Response(
    full_bounded, 0);
}
