...
static size_t _ListRobotStatesInWarehouse_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_moveit_msgs__srv__ListRobotStatesInWarehouse_Request(
    full_bounded, 0);
}
...
static size_t _ListRobotStatesInWarehouse_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_moveit_msgs__srv__ListRobotStatesInWarehouse_Response(
    full_bounded, 0);
}
