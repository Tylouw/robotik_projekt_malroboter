  ...
  void * untyped_ros_message)
{
  ...
  _GetMotionSequence_Request__ros_msg_type * ros_message = static_cast<_GetMotionSequence_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: request
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static size_t _GetMotionSequence_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_moveit_msgs__srv__GetMotionSequence_Request(
    full_bounded, 0);
}
  ...
  void * untyped_ros_message)
{
  ...
  _GetMotionSequence_Response__ros_msg_type * ros_message = static_cast<_GetMotionSequence_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: response
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static size_t _GetMotionSequence_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_moveit_msgs__srv__GetMotionSequence_Response(
    full_bounded, 0);
}
