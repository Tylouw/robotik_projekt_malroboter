  ...
  void * untyped_ros_message)
{
  ...
  _GetPositionFK_Request__ros_msg_type * ros_message = static_cast<_GetPositionFK_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static size_t _GetPositionFK_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_moveit_msgs__srv__GetPositionFK_Request(
    full_bounded, 0);
}
  ...
  void * untyped_ros_message)
{
  ...
  _GetPositionFK_Response__ros_msg_type * ros_message = static_cast<_GetPositionFK_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: pose_stamped
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static size_t _GetPositionFK_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_moveit_msgs__srv__GetPositionFK_Response(
    full_bounded, 0);
}
