...
static size_t _ChangeControlDimensions_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_moveit_msgs__srv__ChangeControlDimensions_Request(
    full_bounded, 0);
}
...
static size_t _ChangeControlDimensions_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_moveit_msgs__srv__ChangeControlDimensions_Response(
    full_bounded, 0);
}
