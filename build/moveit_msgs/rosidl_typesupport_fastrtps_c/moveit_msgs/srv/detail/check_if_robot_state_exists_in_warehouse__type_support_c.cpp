...
{
  return max_serialized_size_moveit_msgs__srv__CheckIfRobotStateExistsInWarehouse_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_moveit_msgs__srv__CheckIfRobotStateExistsInWarehouse_Response(
    full_bounded, 0);
}
