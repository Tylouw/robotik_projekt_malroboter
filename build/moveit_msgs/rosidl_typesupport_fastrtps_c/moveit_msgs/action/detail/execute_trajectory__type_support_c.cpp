...
{
  return max_serialized_size_moveit_msgs__action__ExecuteTrajectory_Goal(
    full_bounded, 0);
}
...
{
  return max_serialized_size_moveit_msgs__action__ExecuteTrajectory_Result(
    full_bounded, 0);
}
...
{
  return max_serialized_size_moveit_msgs__action__ExecuteTrajectory_Feedback(
    full_bounded, 0);
}
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, moveit_msgs, action, ExecuteTrajectory_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
{
  return max_serialized_size_moveit_msgs__action__ExecuteTrajectory_SendGoal_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_moveit_msgs__action__ExecuteTrajectory_SendGoal_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_moveit_msgs__action__ExecuteTrajectory_GetResult_Request(
    full_bounded, 0);
}
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, moveit_msgs, action, ExecuteTrajectory_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
{
  return max_serialized_size_moveit_msgs__action__ExecuteTrajectory_GetResult_Response(
    full_bounded, 0);
}
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, moveit_msgs, action, ExecuteTrajectory_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
{
  return max_serialized_size_moveit_msgs__action__ExecuteTrajectory_FeedbackMessage(
    full_bounded, 0);
}
