...
{
  return max_serialized_size_moveit_msgs__action__Pickup_Goal(
    full_bounded, 0);
}
...
{
  return max_serialized_size_moveit_msgs__action__Pickup_Result(
    full_bounded, 0);
}
...
{
  return max_serialized_size_moveit_msgs__action__Pickup_Feedback(
    full_bounded, 0);
}
...
{
  return max_serialized_size_moveit_msgs__action__Pickup_SendGoal_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_moveit_msgs__action__Pickup_SendGoal_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_moveit_msgs__action__Pickup_GetResult_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_moveit_msgs__action__Pickup_GetResult_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_moveit_msgs__action__Pickup_FeedbackMessage(
    full_bounded, 0);
}
