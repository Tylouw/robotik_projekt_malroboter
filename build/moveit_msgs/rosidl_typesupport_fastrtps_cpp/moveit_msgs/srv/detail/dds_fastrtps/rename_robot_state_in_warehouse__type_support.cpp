...
{
  return max_serialized_size_RenameRobotStateInWarehouse_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_RenameRobotStateInWarehouse_Response(full_bounded, 0);
}
