...
{
  return max_serialized_size_ListRobotStatesInWarehouse_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_ListRobotStatesInWarehouse_Response(full_bounded, 0);
}
