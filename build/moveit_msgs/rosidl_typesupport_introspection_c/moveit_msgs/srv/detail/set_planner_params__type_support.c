...
void SetPlannerParams_Request__rosidl_typesupport_introspection_c__SetPlannerParams_Request_init_function(
...
void SetPlannerParams_Request__rosidl_typesupport_introspection_c__SetPlannerParams_Request_fini_function(void * message_memory)
{
  moveit_msgs__srv__SetPlannerParams_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SetPlannerParams_Request__rosidl_typesupport_introspection_c__SetPlannerParams_Request_message_member_array[5] = {
  {
    "pipeline_id",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers SetPlannerParams_Request__rosidl_typesupport_introspection_c__SetPlannerParams_Request_message_members = {
  "moveit_msgs__srv",  // message namespace
  "SetPlannerParams_Request",  // message name
  5,  // number of fields
  sizeof(moveit_msgs__srv__SetPlannerParams_Request),
  SetPlannerParams_Request__rosidl_typesupport_introspection_c__SetPlannerParams_Request_message_member_array,  // message members
  SetPlannerParams_Request__rosidl_typesupport_introspection_c__SetPlannerParams_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  SetPlannerParams_Request__rosidl_typesupport_introspection_c__SetPlannerParams_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t SetPlannerParams_Request__rosidl_typesupport_introspection_c__SetPlannerParams_Request_message_type_support_handle = {
  0,
  &SetPlannerParams_Request__rosidl_typesupport_introspection_c__SetPlannerParams_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, srv, SetPlannerParams_Request)() {
  SetPlannerParams_Request__rosidl_typesupport_introspection_c__SetPlannerParams_Request_message_member_array[3].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, msg, PlannerParams)();
  if (!SetPlannerParams_Request__rosidl_typesupport_introspection_c__SetPlannerParams_Request_message_type_support_handle.typesupport_identifier) {
    SetPlannerParams_Request__rosidl_typesupport_introspection_c__SetPlannerParams_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &SetPlannerParams_Request__rosidl_typesupport_introspection_c__SetPlannerParams_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void SetPlannerParams_Response__rosidl_typesupport_introspection_c__SetPlannerParams_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void SetPlannerParams_Response__rosidl_typesupport_introspection_c__SetPlannerParams_Response_fini_function(void * message_memory)
{
  moveit_msgs__srv__SetPlannerParams_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SetPlannerParams_Response__rosidl_typesupport_introspection_c__SetPlannerParams_Response_message_member_array[1] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers SetPlannerParams_Response__rosidl_typesupport_introspection_c__SetPlannerParams_Response_message_members = {
  "moveit_msgs__srv",  // message namespace
  "SetPlannerParams_Response",  // message name
  1,  // number of fields
  sizeof(moveit_msgs__srv__SetPlannerParams_Response),
  SetPlannerParams_Response__rosidl_typesupport_introspection_c__SetPlannerParams_Response_message_member_array,  // message members
  SetPlannerParams_Response__rosidl_typesupport_introspection_c__SetPlannerParams_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  SetPlannerParams_Response__rosidl_typesupport_introspection_c__SetPlannerParams_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t SetPlannerParams_Response__rosidl_typesupport_introspection_c__SetPlannerParams_Response_message_type_support_handle = {
  0,
  &SetPlannerParams_Response__rosidl_typesupport_introspection_c__SetPlannerParams_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, srv, SetPlannerParams_Response)() {
  if (!SetPlannerParams_Response__rosidl_typesupport_introspection_c__SetPlannerParams_Response_message_type_support_handle.typesupport_identifier) {
    SetPlannerParams_Response__rosidl_typesupport_introspection_c__SetPlannerParams_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &SetPlannerParams_Response__rosidl_typesupport_introspection_c__SetPlannerParams_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
