...
{
  moveit_msgs__msg__MotionSequenceRequest * msg = (moveit_msgs__msg__MotionSequenceRequest *)malloc(sizeof(moveit_msgs__msg__MotionSequenceRequest));
  if (!msg) {
    return NULL;
  }
...
moveit_msgs__msg__MotionSequenceRequest__Sequence__init(moveit_msgs__msg__MotionSequenceRequest__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (moveit_msgs__msg__MotionSequenceRequest *)calloc(size, sizeof(moveit_msgs__msg__MotionSequenceRequest));
    if (!data) {
      return false;
    }
...
{
  moveit_msgs__msg__MotionSequenceRequest__Sequence * array = (moveit_msgs__msg__MotionSequenceRequest__Sequence *)malloc(sizeof(moveit_msgs__msg__MotionSequenceRequest__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  moveit_msgs__msg__MotionSequenceRequest__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    moveit_msgs__msg__MotionSequenceRequest * data =
      (moveit_msgs__msg__MotionSequenceRequest *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__msg__MotionSequenceRequest__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__msg__MotionSequenceRequest__fini(&data[i]);
        }
        free(data);
        return false;
      }
