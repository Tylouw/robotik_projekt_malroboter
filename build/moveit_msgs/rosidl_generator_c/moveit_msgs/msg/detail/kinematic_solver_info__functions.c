...
{
  moveit_msgs__msg__KinematicSolverInfo * msg = (moveit_msgs__msg__KinematicSolverInfo *)malloc(sizeof(moveit_msgs__msg__KinematicSolverInfo));
  if (!msg) {
    return NULL;
  }
...
moveit_msgs__msg__KinematicSolverInfo__Sequence__init(moveit_msgs__msg__KinematicSolverInfo__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (moveit_msgs__msg__KinematicSolverInfo *)calloc(size, sizeof(moveit_msgs__msg__KinematicSolverInfo));
    if (!data) {
      return false;
    }
...
{
  moveit_msgs__msg__KinematicSolverInfo__Sequence * array = (moveit_msgs__msg__KinematicSolverInfo__Sequence *)malloc(sizeof(moveit_msgs__msg__KinematicSolverInfo__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  moveit_msgs__msg__KinematicSolverInfo__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    moveit_msgs__msg__KinematicSolverInfo * data =
      (moveit_msgs__msg__KinematicSolverInfo *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__msg__KinematicSolverInfo__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__msg__KinematicSolverInfo__fini(&data[i]);
        }
        free(data);
        return false;
      }
