...
{
  moveit_msgs__action__GlobalPlanner_Goal * msg = (moveit_msgs__action__GlobalPlanner_Goal *)malloc(sizeof(moveit_msgs__action__GlobalPlanner_Goal));
  if (!msg) {
    return NULL;
  }
...
moveit_msgs__action__GlobalPlanner_Goal__Sequence__init(moveit_msgs__action__GlobalPlanner_Goal__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (moveit_msgs__action__GlobalPlanner_Goal *)calloc(size, sizeof(moveit_msgs__action__GlobalPlanner_Goal));
    if (!data) {
      return false;
    }
...
{
  moveit_msgs__action__GlobalPlanner_Goal__Sequence * array = (moveit_msgs__action__GlobalPlanner_Goal__Sequence *)malloc(sizeof(moveit_msgs__action__GlobalPlanner_Goal__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  moveit_msgs__action__GlobalPlanner_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    moveit_msgs__action__GlobalPlanner_Goal * data =
      (moveit_msgs__action__GlobalPlanner_Goal *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__GlobalPlanner_Goal__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__GlobalPlanner_Goal__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  moveit_msgs__action__GlobalPlanner_Result * msg = (moveit_msgs__action__GlobalPlanner_Result *)malloc(sizeof(moveit_msgs__action__GlobalPlanner_Result));
  if (!msg) {
    return NULL;
  }
...
moveit_msgs__action__GlobalPlanner_Result__Sequence__init(moveit_msgs__action__GlobalPlanner_Result__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (moveit_msgs__action__GlobalPlanner_Result *)calloc(size, sizeof(moveit_msgs__action__GlobalPlanner_Result));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  moveit_msgs__action__GlobalPlanner_Result__Sequence * array = (moveit_msgs__action__GlobalPlanner_Result__Sequence *)malloc(sizeof(moveit_msgs__action__GlobalPlanner_Result__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  moveit_msgs__action__GlobalPlanner_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    moveit_msgs__action__GlobalPlanner_Result * data =
      (moveit_msgs__action__GlobalPlanner_Result *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__GlobalPlanner_Result__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__GlobalPlanner_Result__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  moveit_msgs__action__GlobalPlanner_Feedback * msg = (moveit_msgs__action__GlobalPlanner_Feedback *)malloc(sizeof(moveit_msgs__action__GlobalPlanner_Feedback));
  if (!msg) {
    return NULL;
  }
...
moveit_msgs__action__GlobalPlanner_Feedback__Sequence__init(moveit_msgs__action__GlobalPlanner_Feedback__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (moveit_msgs__action__GlobalPlanner_Feedback *)calloc(size, sizeof(moveit_msgs__action__GlobalPlanner_Feedback));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  moveit_msgs__action__GlobalPlanner_Feedback__Sequence * array = (moveit_msgs__action__GlobalPlanner_Feedback__Sequence *)malloc(sizeof(moveit_msgs__action__GlobalPlanner_Feedback__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  moveit_msgs__action__GlobalPlanner_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    moveit_msgs__action__GlobalPlanner_Feedback * data =
      (moveit_msgs__action__GlobalPlanner_Feedback *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__GlobalPlanner_Feedback__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__GlobalPlanner_Feedback__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  moveit_msgs__action__GlobalPlanner_SendGoal_Request * msg = (moveit_msgs__action__GlobalPlanner_SendGoal_Request *)malloc(sizeof(moveit_msgs__action__GlobalPlanner_SendGoal_Request));
  if (!msg) {
    return NULL;
  }
...
moveit_msgs__action__GlobalPlanner_SendGoal_Request__Sequence__init(moveit_msgs__action__GlobalPlanner_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (moveit_msgs__action__GlobalPlanner_SendGoal_Request *)calloc(size, sizeof(moveit_msgs__action__GlobalPlanner_SendGoal_Request));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  moveit_msgs__action__GlobalPlanner_SendGoal_Request__Sequence * array = (moveit_msgs__action__GlobalPlanner_SendGoal_Request__Sequence *)malloc(sizeof(moveit_msgs__action__GlobalPlanner_SendGoal_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  moveit_msgs__action__GlobalPlanner_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    moveit_msgs__action__GlobalPlanner_SendGoal_Request * data =
      (moveit_msgs__action__GlobalPlanner_SendGoal_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__GlobalPlanner_SendGoal_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__GlobalPlanner_SendGoal_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  moveit_msgs__action__GlobalPlanner_SendGoal_Response * msg = (moveit_msgs__action__GlobalPlanner_SendGoal_Response *)malloc(sizeof(moveit_msgs__action__GlobalPlanner_SendGoal_Response));
  if (!msg) {
    return NULL;
  }
...
moveit_msgs__action__GlobalPlanner_SendGoal_Response__Sequence__init(moveit_msgs__action__GlobalPlanner_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (moveit_msgs__action__GlobalPlanner_SendGoal_Response *)calloc(size, sizeof(moveit_msgs__action__GlobalPlanner_SendGoal_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  moveit_msgs__action__GlobalPlanner_SendGoal_Response__Sequence * array = (moveit_msgs__action__GlobalPlanner_SendGoal_Response__Sequence *)malloc(sizeof(moveit_msgs__action__GlobalPlanner_SendGoal_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  moveit_msgs__action__GlobalPlanner_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    moveit_msgs__action__GlobalPlanner_SendGoal_Response * data =
      (moveit_msgs__action__GlobalPlanner_SendGoal_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__GlobalPlanner_SendGoal_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__GlobalPlanner_SendGoal_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  moveit_msgs__action__GlobalPlanner_GetResult_Request * msg = (moveit_msgs__action__GlobalPlanner_GetResult_Request *)malloc(sizeof(moveit_msgs__action__GlobalPlanner_GetResult_Request));
  if (!msg) {
    return NULL;
  }
...
moveit_msgs__action__GlobalPlanner_GetResult_Request__Sequence__init(moveit_msgs__action__GlobalPlanner_GetResult_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (moveit_msgs__action__GlobalPlanner_GetResult_Request *)calloc(size, sizeof(moveit_msgs__action__GlobalPlanner_GetResult_Request));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  moveit_msgs__action__GlobalPlanner_GetResult_Request__Sequence * array = (moveit_msgs__action__GlobalPlanner_GetResult_Request__Sequence *)malloc(sizeof(moveit_msgs__action__GlobalPlanner_GetResult_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  moveit_msgs__action__GlobalPlanner_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    moveit_msgs__action__GlobalPlanner_GetResult_Request * data =
      (moveit_msgs__action__GlobalPlanner_GetResult_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__GlobalPlanner_GetResult_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__GlobalPlanner_GetResult_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  moveit_msgs__action__GlobalPlanner_GetResult_Response * msg = (moveit_msgs__action__GlobalPlanner_GetResult_Response *)malloc(sizeof(moveit_msgs__action__GlobalPlanner_GetResult_Response));
  if (!msg) {
    return NULL;
  }
...
moveit_msgs__action__GlobalPlanner_GetResult_Response__Sequence__init(moveit_msgs__action__GlobalPlanner_GetResult_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (moveit_msgs__action__GlobalPlanner_GetResult_Response *)calloc(size, sizeof(moveit_msgs__action__GlobalPlanner_GetResult_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  moveit_msgs__action__GlobalPlanner_GetResult_Response__Sequence * array = (moveit_msgs__action__GlobalPlanner_GetResult_Response__Sequence *)malloc(sizeof(moveit_msgs__action__GlobalPlanner_GetResult_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  moveit_msgs__action__GlobalPlanner_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    moveit_msgs__action__GlobalPlanner_GetResult_Response * data =
      (moveit_msgs__action__GlobalPlanner_GetResult_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__GlobalPlanner_GetResult_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__GlobalPlanner_GetResult_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  moveit_msgs__action__GlobalPlanner_FeedbackMessage * msg = (moveit_msgs__action__GlobalPlanner_FeedbackMessage *)malloc(sizeof(moveit_msgs__action__GlobalPlanner_FeedbackMessage));
  if (!msg) {
    return NULL;
  }
...
moveit_msgs__action__GlobalPlanner_FeedbackMessage__Sequence__init(moveit_msgs__action__GlobalPlanner_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (moveit_msgs__action__GlobalPlanner_FeedbackMessage *)calloc(size, sizeof(moveit_msgs__action__GlobalPlanner_FeedbackMessage));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  moveit_msgs__action__GlobalPlanner_FeedbackMessage__Sequence * array = (moveit_msgs__action__GlobalPlanner_FeedbackMessage__Sequence *)malloc(sizeof(moveit_msgs__action__GlobalPlanner_FeedbackMessage__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  moveit_msgs__action__GlobalPlanner_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    moveit_msgs__action__GlobalPlanner_FeedbackMessage * data =
      (moveit_msgs__action__GlobalPlanner_FeedbackMessage *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!moveit_msgs__action__GlobalPlanner_FeedbackMessage__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          moveit_msgs__action__GlobalPlanner_FeedbackMessage__fini(&data[i]);
        }
        free(data);
        return false;
      }
