  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: has_position_limits
  {
    ...
    value_to_yaml(msg.has_position_limits, out);
    out << "\n";
  }
  ...
  // member: min_position
  {
    ...
    out << "min_position: ";
    value_to_yaml(msg.min_position, out);
    out << "\n";
  }
  ...
  // member: max_position
  {
    ...
    out << "max_position: ";
    value_to_yaml(msg.max_position, out);
    out << "\n";
  }
  ...
  // member: has_velocity_limits
  {
    ...
    value_to_yaml(msg.has_velocity_limits, out);
    out << "\n";
  }
  ...
  // member: has_acceleration_limits
  {
    ...
    value_to_yaml(msg.has_acceleration_limits, out);
    out << "\n";
  }
  ...
  // member: has_jerk_limits
  {
    ...
    out << "has_jerk_limits: ";
    value_to_yaml(msg.has_jerk_limits, out);
    out << "\n";
  }
