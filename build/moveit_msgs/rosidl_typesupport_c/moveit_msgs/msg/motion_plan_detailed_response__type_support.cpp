...
static const _MotionPlanDetailedResponse_type_support_symbol_names_t _MotionPlanDetailedResponse_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, moveit_msgs, msg, MotionPlanDetailedResponse)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, msg, MotionPlanDetailedResponse)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, moveit_msgs, msg, MotionPlanDetailedResponse)() {
  return &::moveit_msgs::msg::rosidl_typesupport_c::MotionPlanDetailedResponse_message_type_support_handle;
}
