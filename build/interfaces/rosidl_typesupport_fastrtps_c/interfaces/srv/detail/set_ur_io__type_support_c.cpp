...
#include "interfaces/srv/detail/set_ur_io__rosidl_typesupport_fastrtps_c.h"
...
using _SetUrIo_Request__ros_msg_type = interfaces__srv__SetUrIo_Request;
...
size_t get_serialized_size_interfaces__srv__SetUrIo_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetUrIo_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__srv__SetUrIo_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__srv__SetUrIo_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_interfaces__srv__SetUrIo_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, srv, SetUrIo_Request)() {
...
using _SetUrIo_Response__ros_msg_type = interfaces__srv__SetUrIo_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t get_serialized_size_interfaces__srv__SetUrIo_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetUrIo_Response__ros_msg_type * ros_message = static_cast<const _SetUrIo_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__srv__SetUrIo_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__srv__SetUrIo_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_interfaces__srv__SetUrIo_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, srv, SetUrIo_Response)() {
...
// already included above
// #include "interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "interfaces/srv/set_ur_io.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, srv, SetUrIo)() {
