...
#include "interfaces/msg/detail/waypoints__rosidl_typesupport_fastrtps_c.h"
...
using _Waypoints__ros_msg_type = interfaces__msg__Waypoints;
...
static uint32_t _Waypoints__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__Waypoints(
...
{
  return max_serialized_size_interfaces__msg__Waypoints(
    full_bounded, 0);
}
