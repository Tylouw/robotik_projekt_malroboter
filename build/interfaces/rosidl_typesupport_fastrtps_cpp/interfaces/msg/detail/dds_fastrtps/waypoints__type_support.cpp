...
#include "interfaces/msg/detail/waypoints__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Waypoints *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Waypoints *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Waypoints__handle;
}
