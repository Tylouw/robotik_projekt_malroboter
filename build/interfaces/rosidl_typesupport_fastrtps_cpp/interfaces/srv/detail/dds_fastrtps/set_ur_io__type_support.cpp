...
#include "interfaces/srv/detail/set_ur_io__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::srv::SetUrIo_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::srv::SetUrIo_Request & ros_message)
{
  // Member: set
  cdr >> ros_message.set;
...
{
  auto typed_message =
    static_cast<const interfaces::srv::SetUrIo_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::srv::SetUrIo_Request *>(
    untyped_ros_message);
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_SetUrIo_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, SetUrIo_Request)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_SetUrIo_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
cdr_serialize(
  const interfaces::srv::SetUrIo_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: current
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::srv::SetUrIo_Response & ros_message)
{
  // Member: current
  cdr >> ros_message.current;
...
{
  auto typed_message =
    static_cast<const interfaces::srv::SetUrIo_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interfaces::srv::SetUrIo_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_SetUrIo_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, SetUrIo_Response)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_SetUrIo_Response__handle;
}
...
{
  return &interfaces::srv::typesupport_fastrtps_cpp::_SetUrIo__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, SetUrIo)() {
  return &interfaces::srv::typesupport_fastrtps_cpp::_SetUrIo__handle;
}
