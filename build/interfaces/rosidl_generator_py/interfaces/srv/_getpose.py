...
class Metaclass_Getpose_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__getpose__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__getpose__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__getpose__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__getpose__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__getpose__request
...
class Getpose_Request(metaclass=Metaclass_Getpose_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.eingang = kwargs.get('eingang', bool())
    ...
    @property
    def eingang(self):
        """Message field 'eingang'."""
        return self._eingang

    @eingang.setter
    def eingang(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'eingang' field must be of type 'bool'"
        self._eingang = value
...
class Metaclass_Getpose_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__getpose__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__getpose__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__getpose__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__getpose__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__getpose__response
...
class Metaclass_Getpose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'interfaces.srv.Getpose')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__getpose

            from interfaces.srv import _getpose
            if _getpose.Metaclass_Getpose_Request._TYPE_SUPPORT is None:
                _getpose.Metaclass_Getpose_Request.__import_type_support__()
            if _getpose.Metaclass_Getpose_Response._TYPE_SUPPORT is None:
                _getpose.Metaclass_Getpose_Response.__import_type_support__()


class Getpose(metaclass=Metaclass_Getpose):
    from interfaces.srv._getpose import Getpose_Request as Request
    from interfaces.srv._getpose import Getpose_Response as Response
