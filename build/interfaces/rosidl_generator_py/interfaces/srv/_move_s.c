...
bool interfaces__msg__waypoints__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool interfaces__srv__move__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.srv._move.Move_Request", full_classname_dest, 33) == 0);
  }
  interfaces__srv__Move_Request * ros_message = _ros_message;
  {  // waypoints
    PyObject * field = PyObject_GetAttrString(_pymsg, "waypoints");
    if (!field) {
      return false;
    }
    if (!interfaces__msg__waypoints__convert_from_py(field, &ros_message->waypoints)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // planeorientation
    PyObject * field = PyObject_GetAttrString(_pymsg, "planeorientation");
    if (!field) {
      return false;
    }
    if (!interfaces__msg__point_orientation3_d__convert_from_py(field, &ros_message->planeorientation)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * interfaces__srv__move__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.srv._move");
  ...
  {  // waypoints
    PyObject * field = NULL;
    field = interfaces__msg__waypoints__convert_to_py(&ros_message->waypoints);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // planeorientation
    PyObject * field = NULL;
    field = interfaces__msg__point_orientation3_d__convert_to_py(&ros_message->planeorientation);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "planeorientation", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool interfaces__srv__move__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.srv._move.Move_Response", full_classname_dest, 34) == 0);
  }
  interfaces__srv__Move_Response * ros_message = _ros_message;
  {  // pointtranslation
