  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  interfaces__msg__Waypoints__init(message_memory);
}

void Waypoints__rosidl_typesupport_introspection_c__Waypoints_fini_function(void * message_memory)
{
  interfaces__msg__Waypoints__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember Waypoints__rosidl_typesupport_introspection_c__Waypoints_message_member_array[3] = {
  {
    "x",  // name
    ...
    offsetof(interfaces__msg__Waypoints, x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces__msg__Waypoints, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces__msg__Waypoints, z),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Waypoints__rosidl_typesupport_introspection_c__Waypoints_message_members = {
  ...
  3,  // number of fields
  sizeof(interfaces__msg__Waypoints),
