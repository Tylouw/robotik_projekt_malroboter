...
foreach(_expectedTarget geometric_shapes::geometric_shapes)
...
# Create imported target geometric_shapes::geometric_shapes
add_library(geometric_shapes::geometric_shapes SHARED IMPORTED)

set_target_properties(geometric_shapes::geometric_shapes PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "/opt/ros/galactic/include;/usr/include/eigen3;/usr/include;/usr/include;/usr/include/libqhull_r;${_IMPORT_PREFIX}/include"
...
file(GLOB CONFIG_FILES "${_DIR}/export_geometric_shapesExport-*.cmake")
